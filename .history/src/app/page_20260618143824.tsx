        ...
        <main className="flex-1 px-6 md:px-10 py-6 max-w-7xl mx-auto w-full space-y-6">
          ...
          {activeMenu === 'checklist_wbs' && (
            <section className="animate-fade-in flex flex-col" style={{ minHeight: 0 }}>
              ...
              {wbsViewMode === 'sheet' ? (
                <div className="rounded-2xl overflow-hidden relative" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid #e5e8eb', height: 'calc(100vh - 200px)' }}>
                  <iframe 
                    src="https://docs.google.com/spreadsheets/d/16lGiOWfQhGhGuVdHnP6pqhNeuJ3_GXUFwYeUTXyBH5M/edit?rm=minimal#gid=878328870" 
                    className="w-full h-full border-none absolute inset-0"
                    title="Google Sheets WBS"
                  />
                </div>
              ) : !activeProjectId ? (
                ...
                <div className="text-center p-16 rounded-2xl"
                  ...
                  <p className="text-xs" style={{ color: '#8b95a1' }}>
                    Supabase SQL 편집기에서 <code className="px-1 py-0.5 rounded text-xs" style={{ backgroundColor: '#f2f4f6' }}>wbs_migration.sql</code>을 실행해 주세요.
                  </p>
                </div>
              ) : (
