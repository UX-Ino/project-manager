        ...
        <main className="flex-1 px-6 md:px-10 py-6 max-w-7xl mx-auto w-full space-y-6">
          ...
          {activeMenu === 'deploy_slide' && (
            <section className="space-y-6 animate-fade-in max-w-4xl">
              <div>
                <h2 className="text-xl font-bold text-text-main font-heading">배포리스트 슬라이드 자동화 가이드</h2>
                <p className="text-xs text-text-muted mt-0.5">
                  스프레드시트에 기입된 수정/배포 대장을 기반으로 주간보고용 구글 슬라이드를 1초 만에 자동 생성합니다.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-[#e5e8eb] shadow-sm flex flex-col justify-between transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                      <div>
                        <div className="text-[#3182f6] mb-3"><ExternalLink className="w-8 h-8" /></div>
                        <h4 className="font-bold text-[#191f28] mb-1.5 text-sm">배포 슬라이드 구글 템플릿</h4>
                        <p className="text-xs text-[#4e5968] leading-relaxed mb-4">
                          주간 보고 시 캡처 이미지와 수정 내역을 슬라이드로 변형해주는 공식 구글 프레젠테이션 템플릿입니다. 본인의 구글 드라이브에 복사하여 연동할 수 있습니다.
                        </p>
                      </div>
                      <a 
                        href="https://docs.google.com/presentation/d/1w4YDXGnQZ2p35GmbUdhf_Aq_0yQ-Vggg7ETVk9gsNqw/copy" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="w-full py-2.5 bg-[#3182f6] hover:bg-[#1b64da] text-white text-xs font-semibold rounded-lg text-center transition-colors cursor-pointer block"
                      >
                        구글 슬라이드 템플릿 복사 ↗
                      </a>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-[#e5e8eb] shadow-sm flex flex-col justify-between transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                      <div>
                        ...
                        <h4 className="font-bold text-[#191f28] mb-1.5 text-sm">배포 데이터 연동 스프레드시트</h4>
                        <p className="text-xs text-[#4e5968] leading-relaxed mb-4">
                          슬라이드를 만들기 위한 데이터가 입력될 스프레드시트 템플릿입니다. 시트 내 Apps Script가 포함되어 배포 슬라이드를 자동으로 생성할 수 있습니다.
                        </p>
                      </div>
                      <a 
                        href="https://docs.google.com/spreadsheets/d/16lGiOWfQhGhGuVdHnP6pqhNeuJ3_GXUFwYeUTXyBH5M/copy" 
                        target="_blank" 
                        rel="noopener noreferrer"
                  ...
                  {/* Apps Script 가이드 설명 카드 */}
                  <div className="bg-white p-6 rounded-2xl border border-[#e5e8eb] shadow-sm space-y-4">
                    <h3 className="text-sm font-bold text-[#191f28]">🛠️ 자동 생성 연동 가이드</h3>
                    <div className="text-xs text-[#4e5968] space-y-3 leading-relaxed">
                      <p>
                        <strong>1. 템플릿 슬라이드 ID 설정:</strong><br />
                        복사된 구글 프레젠테이션의 브라우저 주소창(URL)에서 ID를 추출합니다.<br />
                        예: <code>https://docs.google.com/presentation/d/<span className="text-[#3182f6] font-bold">1w4YDXGnQZ...</span>/edit</code> 에서 ID 문자열만 복사합니다.
                      </p>
                      <p>
                        <strong>2. Apps Script에 슬라이드 ID 붙여넣기:</strong><br />
                        복사한 스프레드시트의 <strong>[확장 프로그램] → [Apps Script]</strong> 창을 엽니다.<br />
                        스크립트 코드 상단의 <code>CONFIG.TEMPLATE_SLIDE_ID</code> 변수 값에 복사한 슬라이드 ID를 덮어씌운 후 저장(Ctrl+S)합니다.
                      </p>
                      <p>
                        <strong>3. 슬라이드 생성 작동:</strong><br />
                        스프레드시트 탭으로 돌아가 상단의 <strong>[🔄 WBS / 배포] → [▶ 슬라이드 생성 실행]</strong> 메뉴 버튼을 누르고 권한을 승인해 줍니다.<br />
                        실행이 완료되면 구글 드라이브 내에 신규 슬라이드 문서가 자동으로 생성됩니다.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-[#e5e8eb] shadow-sm space-y-4">
                    <div>
                      <h3 className="text-sm font-bold text-[#191f28]">📊 &quot;배포리스트&quot; 시트 테이블 컬럼 구조 안내</h3>
                      <p className="text-[11px] text-[#8b95a1] mt-0.5">슬라이드 생성기의 정상 작동을 위해 스프레드시트의 탭 명칭을 반드시 <strong>&quot;배포리스트&quot;</strong>로 지정하고 다음 컬럼을 유지해 주세요.</p>
                    </div>
                      ...
                      <table className="w-full text-left text-xs border-collapse border border-[#e5e8eb]">
                        <thead>
                          <tr className="bg-[#f2f4f6] text-[#4e5968] font-bold border-b border-[#e5e8eb]">
                            <th className="p-2.5 border-r border-[#e5e8eb]">시트 열 번호</th>
                            <th className="p-2.5 border-r border-[#e5e8eb]">컬럼 명칭</th>
                            <th className="p-2.5">슬라이드 템플릿 매핑 태그</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-[#e5e8eb] text-[#374151]">
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">B열 (2)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">No</td>
                            <td className="p-2.5 text-[#8b95a1]">— (순번)</td>
                          </tr>
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">C열 (3)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">분류</td>
                            <td className="p-2.5 font-semibold text-[#1a3a5c]"><code>{"{분류}"}</code></td>
                          </tr>
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">D열 (4)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">수정내용</td>
                            <td className="p-2.5 font-semibold text-[#1a3a5c]"><code>{"{수정내용}"}</code></td>
                          </tr>
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">E열 (5)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">작업자</td>
                            <td className="p-2.5 font-semibold text-[#1a3a5c]"><code>{"{작업자}"}</code></td>
                          </tr>
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">F열 (6)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">URL</td>
                            <td className="p-2.5 font-semibold text-[#1a3a5c]"><code>{"{url}"}</code></td>
                          </tr>
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">G열 (7)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">이미지</td>
                            <td className="p-2.5 text-[#8b95a1]">— (수정 캡처 화면 삽입)</td>
                          </tr>
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">H열 (8)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">이미지 URL</td>
                            <td className="p-2.5 text-[#8b95a1]">— (Apps Script가 실행 시 내부 드라이브 이미지 주소 자동 기입)</td>
                          </tr>
                          <tr>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-mono">I열 (9)</td>
                            <td className="p-2.5 border-r border-[#e5e8eb] font-bold">주석명</td>
                            <td className="p-2.5 font-semibold text-[#1a3a5c]"><code>{"{주석명}"}</code></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
